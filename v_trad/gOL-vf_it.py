...
pgm.display.set_caption("Gioco della vita")

compteur = 0  # Initalisation du compteur
# Création des textes
arialFont = pgm.font.SysFont("arial", 20)
titre = arialFont.render("Gioco della vita di Conway", 1, (0, 0, 0))
play = arialFont.render("Giocare", 1, (0, 0, 0))
dim_txt = arialFont.render("Numero di celle per lato", 1, (0, 0, 0))
taille_txt = arialFont.render("Dimensione dei pixel", 1, (0, 0, 0))
start = arialFont.render("Iniziare", 1, (0, 0, 0))
gen = arialFont.render("Generazione 0", 1, (0, 0, 0))
        ...
        if event.type == pgm.KEYDOWN:
            ...
            if event.type == pgm.KEYDOWN and event.key == pgm.K_RIGHT:
                ...
                gen = arialFont.render(
                    f"Generazione {compteur}", 1, (0, 0, 0)
