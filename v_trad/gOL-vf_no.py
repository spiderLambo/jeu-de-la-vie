...
pgm.display.set_caption("Livets spill")

compteur = 0  # Initalisation du compteur
# Création des textes
arialFont = pgm.font.SysFont("arial", 20)
titre = arialFont.render("Conways livsspill", 1, (0, 0, 0))
play = arialFont.render("Spille", 1, (0, 0, 0))
dim_txt = arialFont.render("Antall celler per side", 1, (0, 0, 0))
taille_txt = arialFont.render("Pikselstørrelse", 1, (0, 0, 0))
start = arialFont.render("Begynne", 1, (0, 0, 0))
gen = arialFont.render("Generasjon 0", 1, (0, 0, 0))
