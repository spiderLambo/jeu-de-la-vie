...
pgm.display.set_caption("Qun jIvon")

compteur = 0  # Initalisation du compteur
# Création des textes
arialFont = pgm.font.SysFont("arial", 20)
titre = arialFont.render("Conway jIvon qun", 1, (0, 0, 0))
play = arialFont.render("ghaj", 1, (0, 0, 0))
dim_txt = arialFont.render("Hutpu' je mI' wa'DIch", 1, (0, 0, 0))
taille_txt = arialFont.render("pixel qay'", 1, (0, 0, 0))
start = arialFont.render("puv", 1, (0, 0, 0))
gen = arialFont.render("vo' 0", 1, (0, 0, 0))
