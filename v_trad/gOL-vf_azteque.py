...
pgm.display.set_caption("Tlakatl in ihtic")

compteur = 0  # Initalisation du compteur
# Création des textes
arialFont = pgm.font.SysFont("arial", 20)
titre = arialFont.render("Tlakatl in ihtic Conway", 1, (0, 0, 0))
play = arialFont.render("Tlakatilia", 1, (0, 0, 0))
dim_txt = arialFont.render("Cuetlaxcalli in tlatzintli tlahtolli", 1, (0, 0, 0))
taille_txt = arialFont.render("Tlahtolli tlanahualli", 1, (0, 0, 0))
start = arialFont.render("Cuetzca", 1, (0, 0, 0))
gen = arialFont.render("xihuitl 0", 1, (0, 0, 0))
