...
pgm.display.set_caption("生命のゲーム")

compteur = 0  # Initalisation du compteur
# Création des textes
arialFont = pgm.font.SysFont("arial", 20)
titre = arialFont.render("コンウェイの生命のゲーム", 1, (0, 0, 0))
play = arialFont.render("遊ぶ", 1, (0, 0, 0))
dim_txt = arialFont.render("辺ごとのセルの数", 1, (0, 0, 0))
taille_txt = arialFont.render("ピクセルサイズ", 1, (0, 0, 0))
start = arialFont.render("始める", 1, (0, 0, 0))
gen = arialFont.render("世代 0", 1, (0, 0, 0))
