...
pgm.display.set_caption("Spiel des Lebens")

compteur = 0  # Initalisation du compteur
# Création des textes
arialFont = pgm.font.SysFont("arial", 20)
titre = arialFont.render(" Conways Spiel des Lebens", 1, (0, 0, 0))
play = arialFont.render("Spielen", 1, (0, 0, 0))
dim_txt = arialFont.render("Anzahl der Zellen pro Seite", 1, (0, 0, 0))
taille_txt = arialFont.render("Pixelgröße", 1, (0, 0, 0))
start = arialFont.render("Starten", 1, (0, 0, 0))
