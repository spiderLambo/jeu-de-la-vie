...
pgm.display.set_caption("Jwèt Lavi")

compteur = 0  # Initalisation du compteur
# Création des textes
arialFont = pgm.font.SysFont("arial", 20)
titre = arialFont.render("Jwèt Lavi Conway", 1, (0, 0, 0))
play = arialFont.render("Jwe", 1, (0, 0, 0))
dim_txt = arialFont.render("Kantite sèl pa kote", 1, (0, 0, 0))
taille_txt = arialFont.render("Taille pixèl", 1, (0, 0, 0))
start = arialFont.render("Kòmanse", 1, (0, 0, 0))
gen = arialFont.render("Jenerasyon 0", 1, (0, 0, 0))
